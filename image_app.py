...
# Disable the submit button unless the correct password is entered
if entered_password == PASSWORD:
    submit_button = 1
else:
    st.error("Enter the correct password to enable the submit button.")
...
if prompt_input and submit_button:
    client = OpenAI()
